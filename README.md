...
git config --global user.email "aishavripatel@gmail.com"
git config --global user.name "Aishwarya-09sm"
ssh-keygen -t ed25519 -C "aishavripatel@gmail.com"
git init
git add pom.xml
git add src
git commit -m "first"
git branch -M main
git remote add origin git@github.com:Aishwarya-09sm/pra.git
git remote set-url origin git@github.com:Aishwarya-09sm/pra.git
...
gedit mypb.yml
 ...
 - name: First Playbook
   ...
   tasks:
     - name: My first task
       debug:
         msg: "Ansible is popular"
         
         
         
ansible-playbook -i hosts.init mypb.yml
mkdir -p library
cd library
